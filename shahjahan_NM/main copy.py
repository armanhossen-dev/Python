...
# Simpson's 1/3 needs an EVEN number of intervals.
# Simpson's 3/8 needs a number of intervals divisible by 3.
# -> use an interval count divisible by 6 (LCM of 2 and 3) so all three
#    rules can be applied to the exact same panel of data.
